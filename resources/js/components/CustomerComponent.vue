                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select v-model="queryField" class="form-control" id="fileds">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                <tr v-show="customers.length" v-for="(customer, index) in customers"
                                    :key="customer.id">
        ...
        methods:{
            ...
            searchData(){
                ...
                axios.get('/api/search/customers/'+this.queryField+'/'+this.query+'?page='+this.pagination.current_page)
                    .then(responce=>{
                        this.customers = responce.data.data
                        this.pagination = responce.data.meta
                        this.$Progress.finish();
                    })
                    .catch(e=>{
                        console.log(e)
                ...
                this.form.post("/api/customers")
                    .then(response=>{
                        ...
                        if(this.form.successful){
                            ...
                            this.$Progress.fail();
                            this.$snotify.error('Something went wrong please try agian later','Error');
                        }
                    })
                .catch(e=>{
                    this.$Progress.fail()
